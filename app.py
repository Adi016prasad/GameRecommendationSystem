...
def search_similar(query, k=5):#STEP 5:Search for similiar query
    ...
    distances, indices = index.search(query_embedding, k)#STEP 7:do index search of those 5 similiar embeddings and obtain indices
...
#feedback mechanisms        
    ...
    if st.button("Submit Feedback", key="submit_feedback"):
        save_feedback(query, feedback)             #STEP 9:get the feedback
