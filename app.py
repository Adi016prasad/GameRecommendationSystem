...
if not firebase_admin._apps:
    cred = credentials.Certificate("path to your json file")  # Replace with the path to your Firebase JSON file
    firebase_admin.initialize_app(cred, {
        'databaseURL': 'provide here your project databse url'
    })
...
def save_feedback_to_firebase(query, feedback):
    ref = db.reference('provide here the name of node')
    feedback_data = {
